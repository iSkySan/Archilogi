...
//    }
        ...
        PersonneController personneController = new PersonneController(personneDAOimpl, personneDTO, personneVue);

        personneController.SetNom("Doe");
        personneController.SetPrenom("John");
        personneController.enregistrer();
        personneController.afficherPage();
    }}
